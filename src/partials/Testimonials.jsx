...
import KarenImg from '../images/Karen.jpg';
...
import ShrijaaImg from '../images/Shrijaa.jpg';
import SaadiaImg from '../images/Saadia.jpg';
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  ...
                  <img className="relative rounded-full" src={SaadiaImg} width="96" height="96" alt="Testimonial 01" />
                </div>
                <blockquote className="text-xl font-medium mb-4">
                  “ Hello everyone! My name is Saadia. I am a junior majoring in Neuroscience. I will be your treasurer this year. I joined LifeSkillsUTD because I wanted to be able to bring events to campus that would teach students the necessary skills that they need as they transition into life as an adult. I am most excited about the cooking class. A fun fact about me is that I am a huge cat person. “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">Saadia Shaikh</cite>
                <div className="text-gray-600">
                  <span>Treasurer</span>
                </div>
              </div>
